...
# Configurações
input_folder = "etc/Remove BG/1400x1400"
...
for filename in os.listdir(input_folder):
    if filename.lower().endswith(('.jpg', '.jpeg', '.png')):
        ...
        if 'fa3c2825' in filename:
            output_filename = 'Fabricio_90x90.png'
        elif '1467ea1f' in filename:
            output_filename = 'Vitoria_90x90.png'
        else:
